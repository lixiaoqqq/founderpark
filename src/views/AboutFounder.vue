     ...
     <div class="subform_maim">
      <div class="toptext">
        ...
        <div style="
                ...
                margin: 5% 0px;
            ">
            <span>FounderPark是极客公园孵化的科技创业者社区，面向 AGI时代里的优秀创业者，推动创新产品的诞生。通过对优秀创业者的筛选、运营和服务（知识服务、创新服务、投融资服务），促进优秀创业者之间的深度联结、认知流动和共同成长 —— Founders Backing Founders。</span>
            <br>
            <br>
            <!-- <p></p> -->
        </div>
        ...
        <div class="shequ">
            <p>AGI 社区</p>
            <span>
              于2023年3月成立，社区集聚了超3000位致力在大模型相关领域创业的创业者、产品经理、研发工程师、对大模型技术和场景应用开发进展感兴趣的学者及投资人。群内会定期举办主题研讨会、组织跨群的资源交流和AGI国内活动信息交换。
            </span>
        </div>
        <div class="founder_logo">
        ...
        <div class="shequ">
            <p>前沿社</p>
            <span>
              由极客公园于2017年发起成立的科技企业家社区，聚集着大量优秀的新生代创业者和商业领袖，80%为公司B轮以上及IPO阶段。每月前沿社都将组织闭⻔学习交流活动，深度探讨技术前沿趋势、商业组织成长的方法论，追求以最有效率的学习和沟通机制，帮助企业家自我提升、刷新认知。
            </span>
        </div>
